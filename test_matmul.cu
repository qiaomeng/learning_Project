...
int main()
{
	...
	if(1){
		...
		cudaMemcpy2D(cuda_a, sizeof(float) * n, a, sizeof(float) * n, sizeof(float) * n, n, cudaMemcpyHostToDevice);
		cudaMemcpy2D(cuda_b, sizeof(float) * n, b, sizeof(float) * n, sizeof(float) * n, n, cudaMemcpyHostToDevice);
	}
	...
	if(1)
		...
		cudaMemcpy2D(c, sizeof(float) * n, cuda_c, sizeof(float) * n, sizeof(float) * n, n, cudaMemcpyDeviceToHost);
